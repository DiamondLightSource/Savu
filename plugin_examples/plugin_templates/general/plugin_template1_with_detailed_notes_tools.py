...
class DarkFlatFieldCorrectionTools(PluginTools):
    """
    A description of the plugin - the synopsis in the 
    
    
    the synopsis above appears as the short
...
appears as the longer description (-vv flag).
    ...
    """
    # which is the short and which is the long description now in savu_config?
