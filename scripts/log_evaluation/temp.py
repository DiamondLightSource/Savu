...
# multi only 
#dir_path = ['/dls/science/users/qmm55171/final_logs/new_mpi_params/no_chunking/log_files/',
#            '/dls/science/users/qmm55171/final_logs/original_mpi_params/no_chunking/log_files/',
#            '/dls/science/users/qmm55171/final_logs/original_mpi_params/chunk_true/log_files/',
#           ]

dir_path = [
            '/dls/science/users/qmm55171/final_logs/testing/log_files/'
           ]
