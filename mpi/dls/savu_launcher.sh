...
qsub -N $outname -sync y -j y -o /dls/tmp/savu/$USER -e /dls/tmp/savu/$USER -pe openmpi $M -l infiniband -q medium.q@@com10 $filepath $savupath $datafile $processfile $outpath $nCPUs > /dls/tmp/savu/$USER.out
