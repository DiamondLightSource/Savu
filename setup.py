...
setup(name='savu',
      ...
      scripts=[facility_path+'/savu_launcher.sh',facility_path+'/savu_mpijob.sh', 'install/savu_installer.sh',
              'install/savu_setup.sh', 'install/mpi_cpu_test.sh', 'install/mpi_gpu_test.sh'],
