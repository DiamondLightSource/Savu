...
.. toctree::
    Plugin documention and guidelines on use </../documentation/tomobar_recon_doc.rst>
...
.. code-block:: yaml
        ...
        regularisation_iterations:
            ...
            description: 
                ...
                range: The recommended value with the chosen regularisation_method would be 500
            default: 
                regularisation_method: 
                    ROF_TV: 1000
                    FGP_TV: 500
