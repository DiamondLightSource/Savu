...
class TransportMechanism(object):
    ...
    def add_data_block(self, name, shape, dtype):
        raise NotImplementedError("add data block needs to be implemented in %s", self.__class__)

    def get_data_block(self, name):
        raise NotImplementedError("get data block needs to be implemented in  %s", self.__class__)
