...
#        
#    def plugin_setup(self, **kwargs):
#        plugin_dataset = Pattern(self, kwargs)
#        try:
...
#        self.obj = data_obj
#        print "*** creating a pattern", data_obj.name
#        self.meta_data = MetaData()
...
#        return [fixed, values]
#
#    def delete_fixed_directions(self): # *** do I need this anymore?
#        try:
