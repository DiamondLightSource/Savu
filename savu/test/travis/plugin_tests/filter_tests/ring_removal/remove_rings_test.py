...
class RemoveRingsTest(unittest.TestCase):
    ...
    def test_remove_large_rings(self):
        ...
        options['process_file'] = tu.get_test_process_path('ring_removal/ring_removal_large_test.nxs')
    ...
    def test_ring_removal_filtering(self):
        ...
        options['data_file'] = data_file
        options['out_path'] = os.path.join(self.test_folder)
        options['process_file'] = tu.get_test_process_path('ring_removal/ring_removal_filtering_test.nxs')
        run_protected_plugin_runner(options)
    ...
    def test_ring_removal_fitting(self):
        ...
        options['data_file'] = data_file
        options['out_path'] = os.path.join(self.test_folder)
        options['process_file'] = tu.get_test_process_path('ring_removal/ring_removal_fitting_test.nxs')
        run_protected_plugin_runner(options)
    ...
    def test_ring_removal_normalization(self):
        ...
        options['data_file'] = data_file
        options['out_path'] = os.path.join(self.test_folder)
        options['process_file'] = tu.get_test_process_path('ring_removal/ring_removal_normalization_test.nxs')
        run_protected_plugin_runner(options)
    ...
    def test_ring_removal_regularization(self):
        ...
        options['data_file'] = data_file
        options['out_path'] = os.path.join(self.test_folder)
        options['process_file'] = tu.get_test_process_path('ring_removal/ring_removal_regularization_test.nxs')
        run_protected_plugin_runner(options)
    ...
    def test_ring_removal_sorting(self):
        ...
        options['data_file'] = data_file
        options['out_path'] = os.path.join(self.test_folder)
        options['process_file'] = tu.get_test_process_path('ring_removal/ring_removal_sorting_test.nxs')
        run_protected_plugin_runner(options)
