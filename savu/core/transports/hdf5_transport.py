...
#        self.plugin_loader(plugin_list[0])
#
#        start_data = self.exp.index['in_data'].copy()
#        print "the start_data is:", start_data
#
#        exp.barrier()
...
#
#        print "in_data after creating output files:", self.exp.index['in_data']
#
#        exp.barrier()
#        logging.info("clear all out_data objects in experiment dictionary")
#        exp.clear_data_objects()
#
#        print "clearing the data objects:", self.exp.index['in_data']
#        self.exp.index['in_data'] = start_data
#        print "reattaching the data objects:", self.exp.index['in_data']
#
#        exp.barrier()
