...
@register_plugin
class AstraReconVectorGpu(BaseAstraVectorRecon, GpuPlugin):
    """
    ...
    def __init__(self):
        super(AstraReconVectorGpu, self).__init__("AstraReconVectorGpu")
        self.GPU_index = None
        self.res = False
        self.start = 0
    ...
    def astra_2D_vector_recon(self, data):
        ...
        self.proj_id = astra.create_projector('cuda', proj_geom, vol_geom) # for GPU
...
#            cors.append(0)
    ...
    def get_citation_information(self):
        ...
        return super(AstraReconVectorGpu, self).get_citation_information() + \
            [cite_info]
