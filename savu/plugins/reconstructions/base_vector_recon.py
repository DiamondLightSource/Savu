...
"""
.. module:: base_vector_recon
   :platform: Unix
   :synopsis: A base class for vector-based Astra reconstruction
...
class BaseVectorRecon(Plugin):
    ...
    def __init__(self, name='BaseVectorRecon'):
        super(BaseVectorRecon, self).__init__(name)
        self.nOut = 1
        self.nIn = 1
        self.scan_dim = None
        self.rep_dim = None
