...
#        return [np.array([pos])]
    ...
    def setup(self):
        ...
        fixed_dim = list(self.spatial_dims.difference(set(in_pData[1].get_core_dimensions())))
        ...
        fixed_dim = list(self.spatial_dims.difference(set(in_pData[2].get_core_dimensions())))
