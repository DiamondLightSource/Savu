...
class CropProjections(Plugin, CpuPlugin):
    ...
    def setup(self):
        ...
        self.xcrop = self.parameters['cropX']
        self.ycrop = self.parameters['cropY']
        self.xsize = self.parameters['sizeX']
        self.ysize = self.parameters['sizeY']
    ...
    def process_frames(self, data):   
        return data[0][tuple(self.new_slice)]    
