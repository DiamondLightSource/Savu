...
"""
.. module:: distortion_correction_deprecated
   :platform: Unix
...
@register_plugin
class DistortionCorrectionDeprecated(BaseFilter, CpuPlugin):
    """
    ...
    def __init__(self):
        super(DistortionCorrectionDeprecated, self).__init__("DistortionCorrectionDeprecated")
