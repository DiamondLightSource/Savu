...
"""
.. module:: A plugin to crop projections manually or automatically
   :platform: Unix
   :synopsis: A plugin to crop projection manually or automatically
.. moduleauthor:: Daniil Kazantsev, Malte Storm <scientificsoftware@diamond.ac.uk>
"""
...
class CropProjections(Plugin, CpuPlugin):
    """
    A plugin to crop projection data manually (by specifying cropping parameters)
    or automatically (works when the object of interest lies fully within the field of view).
