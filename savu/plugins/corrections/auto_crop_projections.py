...
@register_plugin
class AutoCropProjections(Plugin, CpuPlugin):
    """
    A plugin to crop projection data manually (by specifying cropping parameters)
    or automatically (works well when the object of interest lies fully within the field of view).
    ...
    def __init__(self):
        super(AutoCropProjections, self).__init__("AutoCropProjections")
