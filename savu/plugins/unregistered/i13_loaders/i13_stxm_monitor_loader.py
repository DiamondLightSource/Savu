...
"""
.. module:: i13_stxm_monitor_loader
   :platform: Unix
...
class I13StxmMonitorLoader(BaseLoader):
    ...
    def __init__(self, name='I13StxmMonitorLoader'):
        super(I13StxmMonitorLoader, self).__init__(name)
    ...
    def setup(self):
        ...
        exp = self.exp
        data_obj = exp.create_data_object('in_data', 'monitor')

        data_obj.backing_file = \
            h5py.File(self.exp.meta_data.get("data_file"), 'r')

        data_obj.data = data_obj.backing_file['/entry1/merlin_sw_hdf/ionc_photonflux']
