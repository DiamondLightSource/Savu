...
"""
.. module:: region_grow3D
   :platform: Unix
   :synopsis: Fast region-grow type segmentation in 3D from Larix toolbox to evolve a given mask
...
class RegionGrow3d(Plugin, MultiThreadedPlugin):
    ...
    def setup(self):
        ...
        in_pData[1].plugin_data_setup('VOLUME_3D', 'single') # the initialised mask
